...
CREATE TABLE `CouponDiscounts` (
  ...
  `CodeRecipientType` varchar(255) DEFAULT NULL,
  `ApplicableTo` varchar(255) DEFAULT NULL,
  `Product` varchar(255) DEFAULT NULL,
  `PoductType` int(11) DEFAULT NULL,
  `CodeType` varchar(255) DEFAULT NULL,
  `CouponValue` varchar(255) DEFAULT NULL,
  ...
  CONSTRAINT `CouponDiscounts_ibfk_1` FOREIGN KEY (`createdBy`) REFERENCES `Users` (`Id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
INSERT INTO `CouponDiscounts` VALUES (1,'1','Square Yards','SQYRA100','Role','Employee','Rental Agreement',12,'Discount-Fixed','100','100',1,1,'2021-04-22 09:51:57',1,'2021-04-22 09:51:57');
...
-- Dump completed on 2022-01-10 22:17:56
